...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private void init(Context context) {
        ...
        mMessage = mDialogView.findViewById(R.id.messages);
    ...
    /**
     * 设置Dialog标题背景，传入drawable资源
     *
     * @param res
     * @return
     */
    public NiftyDialogBuilder withTitleBackground(int res) {
        mLinearLayoutTopView.setBackgroundColor(res);
        return this;
    }
